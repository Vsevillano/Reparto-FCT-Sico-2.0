...
--
-- Servidor: localhost
-- Tiempo de generación: 24-11-2018 a las 15:59:09
...
CREATE TABLE `Request_student` (
  ...
  `convocatory_id` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `Request_student`
--

INSERT INTO `Request_student` (`id`, `group_id`, `convocatory_id`, `first_name`, `last_name`, `piexento`, `fctexento`) VALUES
(97, 3, 2, 'Angelo', 'Bárbara', 0, 1),
(98, 3, 2, ' Guillermo', 'Boquizo Sánchez', 0, 1),
(99, 3, 2, 'José Manuel', 'Bravo Martínez, ', 0, 1),
(100, 3, 2, 'Darío', 'Fernández Osuna', 0, 1),
(101, 3, 2, 'Mario', 'Ferrer Nieto ', 0, 1),
(102, 3, 2, 'Marcos', 'Gallardo Pérez', 0, 1),
(103, 3, 2, 'Rafael', 'García Zurita', 0, 1),
(104, 3, 2, 'Daniel', 'Gestino Notario', 0, 1),
(105, 3, 2, ' Víctor Manuel', 'Gómez Muñoz', 0, 1),
(106, 3, 2, 'Javier', 'González Guzmán ', 0, 1),
(107, 3, 2, 'Jorge', 'Granados Jurado', 0, 1),
(108, 3, 2, 'José', 'Lucena Morente', 0, 1),
(109, 3, 2, ' Samuel', 'Luque Reyes', 0, 1),
(110, 3, 2, 'Javier', 'Mariscal Solís', 0, 1),
(111, 3, 2, 'Jesús', 'Mejías Leiva', 0, 1),
(112, 3, 2, 'Mario', 'Navarro Madrid ', 0, 1),
(113, 3, 2, 'Francisco', 'Ramírez Ruiz', 0, 1),
(114, 3, 2, 'Jesús', 'Requena Pérez', 0, 1),
(115, 3, 2, ' José María', 'Romero Ruiz', 0, 1),
(116, 3, 2, 'Juan', 'Rueda Morales', 0, 1),
(117, 3, 2, 'Victoriano', 'Sevillano Vega', 0, 1),
(118, 3, 2, 'Rafael Ángel', 'Sojo Ruíz,', 0, 1),
(119, 3, 2, 'Alejandro Luis', 'Vázquez Casillas ', 0, 1);
...
(1, 'admin', 'admin', 'admin@admin.com', 'admin@admin.com', 1, NULL, '$2y$13$JkDEWVqov6Q8EU79EbGnROnXa09P4HyRezShaWeeeoHi6/vkj7vlK', '2018-11-23 16:09:21', NULL, NULL, 'a:1:{i:0;s:10:"ROLE_ADMIN";}', 'admin', 'admin', 0, 'admin.jpeg', NULL),
(2, 'lmagarin', 'lmagarin', 'lmagarin@gmail.com', 'lmagarin@gmail.com', 1, NULL, '$2y$13$X7U..87q2sjrwWEj9FBSJ.iswntdu03r342ZMajN4uoCW/cw9oTf6', '2018-11-24 14:05:20', NULL, NULL, 'a:1:{i:0;s:12:"ROLE_TEACHER";}', 'Lourdes', 'Magarin Corvillo', 1, 'lmagarin.png', 2),
